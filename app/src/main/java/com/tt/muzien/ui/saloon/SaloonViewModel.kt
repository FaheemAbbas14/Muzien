...
class SaloonViewModel(
    ...
    fun getSaloons(page: Int? = null,isActive: Boolean? = null, status: String? = null,) = viewModelScope.launch {
        _getSaloon.value = repository.getSaloons(page,isActive,status)
    }
