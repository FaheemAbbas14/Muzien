...
interface BookingApi {
    @GET("v1/booking")
    suspend fun getBookings(@Query("saloonIds") saloonIds: String?=null,@Query("startDate") startDate: String?=null,@Query("endDate") endDate: String?=null,@Query("status") status: String?=null
    ): GetBookingResponse
}